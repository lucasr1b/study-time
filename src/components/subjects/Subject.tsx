  ...
  return (
    <div className='flex flex-col h-full w-full p-3 gap-1 rounded-lg bg-white border border-zinc-200'>
      ...
      <div className='flex gap-4 mt-1'>
        ...
        <button className='bg-white border border-zinc-200 rounded-md h-8 px-3 hover:bg-zinc-200 text-sm font-medium' onClick={() => props.removeSubject(props.subject.subject_id)}>Remove</button>
      </div>
    </div>
  )
}
