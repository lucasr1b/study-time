    ...
    <div className='fixed z-50 flex flex-col w-1/5 h-auto p-4 rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary'>
      ...
      <div className='flex flex-col gap-2'>
        <div className='inline-flex border border-accent rounded-md p-2 mt-2'>
          <input placeholder='Event title' className='w-full resize-none outline-none bg-primary' />
        </div>
        ...
        <div className='flex gap-2 mt-2'>
          ...
          <div className='flex gap-2 ml-auto'>
            ...
            <button type='button' className='bg-primary border border-accent rounded-md h-8 w-fit px-3 hover:bg-accent text-sm' onClick={props.closeModal}>Add</button>
          </div>
        </div>
      </div>
    </div >
